...
import com.test.test.common.entity.CurrentUser;
import com.test.test.common.entity.IntegralAuthUser;
import com.test.test.common.entity.constant.PageConstant;
...
public class IntegralUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof IntegralAuthUser) {
            return ((IntegralAuthUser) principal).getUsername();
        }
