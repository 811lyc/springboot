...
public class IntegralConstant {
     ...
     * Gateway请求头TOKEN值
     */
    public static final String GATEWAY_TOKEN_VALUE = "integral:gateway:123456";
     ...
     * 验证码 key前缀
     */
    public static final String CODE_PREFIX = "integral.captcha.";

    /**
     * 异步线程池名称
     */
    public static final String ASYNC_POOL = "IntegralAsyncThreadPool";
